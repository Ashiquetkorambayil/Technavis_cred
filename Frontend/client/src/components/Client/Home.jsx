    ...
    return (
        <div>
            ...
            <div className="container-fluid banner-1 bg-light">
             <div className="row">
                 <div className="col-6 text-light py-4  mx-5 " style={{display:'flex', alignItems:'left', justifyContent:'center', flexDirection:'column'}}>
                     ...
                     <Link to='/menu'><Button className='explore-btn'  variant="danger"><p className='montserrat-300 m-0'>Explore Dishes</p></Button>{' '}</Link>
                 </div>
             </div>
         </div>
